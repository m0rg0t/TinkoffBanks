...
namespace TinkoffBanks.ViewModel
{
    public class NewsListViewModel: ViewModelBase
    {
        ...
        public void LoadNews()
        {
            ...
            //{
                ...
                bw.DoWork += delegate
                {
                    var client = new RestClient("https://www.tcsbank.ru");
    ...
    public class NewsViewModel: ViewModelBase
    {
        ...
        public string Title
        {
            ...
            set 
            {
                _title = value.Replace("&nbsp;", " ").Replace("&laquo;", "\"").Replace("&raquo;", "\"");
        ...
        public string Body {
            set
            {
                _body = Regex.Replace(value, "<.+?>", string.Empty).Replace("&nbsp;", " ").Replace("&laquo;", "\"").Replace("&raquo;", "\""); 
